...
# https://github.com/facebookresearch/TimeSformer/blob/main/timesformer/models/conv2d_same.py
# The code does not work as is, so I have made some modifications to make it work.
